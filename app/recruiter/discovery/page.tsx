...
const mockCandidateList: CandidateData[] = [
  {
    ...
    talent_score: 96,
    match_percentage: 96,
    skills: ["React", "Next.js", "Node.js", "Supabase", "TypeScript"],
    ...
    resume_summary: "Senior Full Stack Engineer with 3.5+ years building Next.js production web applications and database integrations.",
    ...
    reason: "Lead developer with expert level React skills and verified Supabase security integrations."
  },
  {
    candidate_id: "cand-2-marcus",
    name: "Marcus Chen",
    ...
    talent_score: 98,
    match_percentage: 98,
    skills: ["React", "Next.js", "TypeScript", "TailwindCSS", "AWS"],
    radarPoints: "64,5 110,24 80,40 20,35 15,20",
    top_projects: [
      { name: "vue-dashboard-suite", description: "Realtime analytics UI with WebSocket feeds", stars: 19 },
    ],
    github_activity: { repo_count: 18, top_language: "TypeScript", total_stars: 94 },
    resume_summary: "Senior Architect with expertise in frontend rendering architectures, design systems, and responsive layouts.",
    fraud_status: { is_verified: true, ai_risk: "Low Risk", audit_date: "Passed June 2026" },
    skill_badges: [
      { skill: "React Architecture", verified: true, source: "GitHub Code Audit" },
    ],
    reason: "Matched 98% with 98/100 Talent Score, verified Next.js/TypeScript repositories."
  },
  {
    candidate_id: "cand-3-david",
    name: "David Miller",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
    github_username: "david-miller-ml",
    ...
    talent_score: 88,
    match_percentage: 95,
    skills: ["Python", "PyTorch", "FastAPI", "Docker", "Go"],
    radarPoints: "50,15 105,20 95,38 35,40 38,22",
    top_projects: [
    ...
    resume_summary: "Machine learning platform engineer specialized in Python microservices, PyTorch model deployment, and vector database lookups.",
    fraud_status: { is_verified: true, ai_risk: "Low Risk (< 3%)", audit_date: "Passed July 2026" },
    skill_badges: [
      { skill: "Python & PyTorch", verified: true, source: "GitHub Repositories" },
    ],
    reason: "Matched 95% with verified Python ML project portfolio."
  },
  {
    candidate_id: "cand-4-sarah",
    name: "Sarah Jenkins",
    avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&auto=format&fit=crop&q=80",
    github_username: "sarah-j",
    ...
    radarPoints: "64,5 110,24 80,40 20,35 15,20",
    top_projects: [
      { name: "k8s-pod-scaler", description: "Custom resource auto-scaler based on queue sizes", stars: 55 }
    ],
    github_activity: { repo_count: 14, top_language: "Go", total_stars: 78 },
    resume_summary: "Distributed systems engineer with focused expertise in Kubernetes container orchestrations and low-latency storage systems.",
    fraud_status: { is_verified: true, ai_risk: "Low Risk", audit_date: "Passed June 2026" },
    skill_badges: [
      { skill: "Go & Kubernetes", verified: true, source: "Infrastructure Audit" }
    ],
    reason: "Outstanding technical depth in Go systems design and cloud orchestrations."
  },
  {
    candidate_id: "cand-5-james",
    name: "James Wilson",
    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80",
    github_username: "jwilson-dev",
    ...
    talent_score: 87,
    match_percentage: 87,
    skills: ["Node.js", "React", "PostgreSQL", "TailwindCSS"],
    radarPoints: "50,10 110,15 100,40 30,42 40,20",
    top_projects: [
      { name: "orbit-chat", description: "Realtime WebSocket messaging client", stars: 12 }
    ],
    github_activity: { repo_count: 9, top_language: "JavaScript", total_stars: 33 },
    resume_summary: "Full stack web developer passionate about modular React component workflows and optimized PostgreSQL schemas.",
    fraud_status: { is_verified: true, ai_risk: "Low Risk", audit_date: "Passed June 2026" },
    skill_badges: [
      { skill: "React Workflows", verified: true, source: "Code Audit" }
    ],
    reason: "Solid full stack developer with consistent contributions."
  },
  {
    candidate_id: "cand-6-linda",
    name: "Linda Wu",
    avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
    github_username: "linda-wu",
    ...
    talent_score: 81,
    match_percentage: 81,
    skills: ["Leadership", "System Design", "Big Data", "Go"],
    radarPoints: "64,2 120,24 100,45 28,45 10,24",
    top_projects: [
      { name: "stream-pipeline", description: "Distributed data ingestion broker", stars: 110 }
    ],
    github_activity: { repo_count: 35, top_language: "Go", total_stars: 310 },
    resume_summary: "Engineering executive with proven experience scaling distributed software teams and big data system designs.",
    fraud_status: { is_verified: true, ai_risk: "Low Risk", audit_date: "Passed July 2026" },
    skill_badges: [
      { skill: "Technical Leadership", verified: true, source: "Corporate Audit" }
    ],
    reason: "Senior engineering leader with extensive system design expertise."
  }
];
